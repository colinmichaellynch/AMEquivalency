...
#' @return A list containing pairs of values which determine all of the sampling strategy whose final sample size is equal to N_1T_Max.
#'   \describe{
#'     \item{TVecAcceptable}{A numeric vector containing all values of T.}
#'     \item{n1VecAcceptable}{A numeric vector containing all values of N1.}
#'   }
#' @export
